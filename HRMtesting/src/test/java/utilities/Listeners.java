...
public class Listeners extends TestListenerAdapter {
    ...
    public void onStart(ITestContext testContext) {
        htmlReporter = new ExtentHtmlReporter(System.getProperty("user.dir") + "/Reports/Extent" +
                "Report.html");
        ...
        extent.setSystemInfo("Project Name", "HRMtesting");
        extent.setSystemInfo("user", "AmanShukla");
    }
